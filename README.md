...
This extension is a small experiment in surfacing that choice at task-definition time inside Inspect AI specifically. An upstream issue proposing the taxonomy + lint as in-core features is open at [`UKGovernmentBEIS/inspect_ai#3770`](https://github.com/UKGovernmentBEIS/inspect_ai/issues/3770). If the upstream lands, this package will be deprecated in favor of in-core support.
